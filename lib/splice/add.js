...
//if deletecount is equal to or greater than length of array, all items should be removed and empty array should be returned
//I think this should just be in remove.js
